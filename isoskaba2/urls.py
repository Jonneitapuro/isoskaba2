...
urlpatterns = [
    ...
    url(r'^$', skabaviews.incredible_password, name='incredible_pass'),
    url(r'^incredible/$', skabaviews.incredible, name='incredible'),
    url(r'^login', skabaviews.incredible_password, name='incredible_pass'),
